...
USER_SETTINGS = getattr(settings, 'DYNAMIC_WIDGETS', None)

DEFAULTS = {
    "API_ROOT":
        "dynamic_widgets.api.endpoint.dynamic_widgets",
    'LOCAL_CONTEXT':
        None,
    'ADDITIONAL_CONTEXT':
        []
#    "DJANGO_TEMPLATE_MODEL":
#        "dynamic_widgets.models.DjangoTemplate",
#    'DYNAMIC_CONTENT_MODEL':
#        'dynamic_widgets.models.DynamicContent',
}
...
IMPORT_STRINGS = (
    "API_ROOT",
#    "WIDGET_STORE__DJANGO_TEMPLATE_MODEL",
#    "DYNAMIC_CONTENT_MODEL",
)
...
dynamic_widgets_settings = LazySettings()
