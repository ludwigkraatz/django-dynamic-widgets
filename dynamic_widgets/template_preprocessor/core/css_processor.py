...
from dynamic_widgets.template_preprocessor.core.django_processor import DjangoContent, DjangoContainer
...
from dynamic_widgets.template_preprocessor.core.html_processor import HtmlNode, HtmlContent
import string
import os
...
def _rewrite_urls(css_node, base_url):
    ...
    from dynamic_widgets.template_preprocessor.core.utils import real_url
    for url_node in css_node.child_nodes_of_class(CssUrl):
