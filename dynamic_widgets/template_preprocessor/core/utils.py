...
def compile_external_javascript_files(media_files, context, compress_tag=None):
    ...
    Return output path.
    """
    from dynamic_widgets.template_preprocessor.core.js_processor import compile_javascript_string
...
def compile_external_css_files(media_files, context, compress_tag=None):
    ...
    Return output path.
    """
    from dynamic_widgets.template_preprocessor.core.css_processor import compile_css_string
