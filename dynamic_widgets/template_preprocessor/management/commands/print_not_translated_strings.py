...
from dynamic_widgets.template_preprocessor.core import compile_to_parse_tree
from dynamic_widgets.template_preprocessor.core.lexer import CompileException

from dynamic_widgets.template_preprocessor.utils import template_iterator, load_template_source
from dynamic_widgets.template_preprocessor.utils import get_options_for_path
...
class Command(BaseCommand):
    ...
    def _compile_template(self, template, input_path):
        try:
            ...
            from dynamic_widgets.template_preprocessor.core.html_processor import HtmlContent, HtmlStyleNode, HtmlScriptNode
